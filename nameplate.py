...
def draw_name(p, x, y, name, affil, dinner=0, workshop=0, congress_color="green", CONSTANT_STRINGS=None, font_name="GenShinGothic"):
    ...
    # 会場・日時
    draw_string(p, x + 60*mm, y -10*mm, PLACE    , font_name=font_name, font_size=7, color="white")
    draw_string(p, x + 60*mm, y - 6*mm, CONG_DATE, font_name=font_name, font_size=7, color="white")
    # 所属・氏名欄
