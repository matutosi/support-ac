...
- **【判断待ち】** 21(2):53 の文献 McIntyre et al. 1989 の行末の「semi-/aquatic」をウェブ版に合わせて `semiaquatic` にした．紙面どおり語のハイフンとみるなら `semi-aquatic` に戻す．
- **【判断待ち】** 所属は機関名までにしている (13〜21 巻とも)．21(1):39 の独立検証が紙面の所在地 (`Fuchu, Tokyo 183-8509, Japan`) が無いと指摘した．巻を通して方針を変えるかを決める．
