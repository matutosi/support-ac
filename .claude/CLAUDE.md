...
- **22 巻の作業ディレクトリと zip がこの PC に無い** (web の worktree `../support-ac-22` にあった．2026-09-25 に MATUTOSI_DP で確認)．
  22 巻は 21 巻の修正の前に組んだので，手元に持ってきたら新しい `validate.py` (印の閉じ忘れ) で確かめ，
  英文要旨を紙面と照合する (21 巻では登録版の写しが 10 本中 4 本で紙面と違った)．
